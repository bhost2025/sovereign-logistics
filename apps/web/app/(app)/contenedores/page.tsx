  ...
  return (
    <div className="p-8 max-w-[1000px]">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-extrabold text-[#0a1a3c] tracking-tight">Contenedores</h1>
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-[#f0f2f5]">
              {['Contenedor', 'BL', 'Cliente', 'Ruta', 'ETA', 'Estado', ''].map(h => (
            ...
            {containers.length === 0 && (
              <tr>
                <td colSpan={7} className="px-5 py-10 text-center text-[#b0bac3]">
                  Sin contenedores. <a href="/contenedores/nuevo" className="text-[#4A6FA5] font-bold">Crear el primero →</a>
                </td>
              </tr>
            )}
          </tbody>
